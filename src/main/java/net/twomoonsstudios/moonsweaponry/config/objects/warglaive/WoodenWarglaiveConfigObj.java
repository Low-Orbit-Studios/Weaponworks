...
import static net.twomoonsstudios.moonsweaponry.constants.MeleeWeaponDataConstants.WOODEN_WARGLAIVE_DEFAULT_DMG;
import static net.twomoonsstudios.moonsweaponry.constants.MeleeWeaponDataConstants.WOODEN_WARGLAIVE_DEFAULT_TIER_NAME;
...
public class WoodenWarglaiveConfigObj extends WarglaiveConfigObj {
    ...
    public WoodenWarglaiveConfigObj(String weaponId, MoonsWeaponsConfig.WeaponInfo objData) {
        super(WoodenWarglaiveConfigObj.class, weaponId, objData);
    }
