...
import static net.twomoonsstudios.moonsweaponry.constants.MeleeWeaponDataConstants.DIAMOND_HALBERD_DEFAULT_DMG;
import static net.twomoonsstudios.moonsweaponry.constants.MeleeWeaponDataConstants.DIAMOND_HALBERD_DEFAULT_TIER_NAME;
...
public class DiamondHalberdConfigObj extends HalberdConfigObj {
    ...
    public DiamondHalberdConfigObj(String weaponId, MoonsWeaponsConfig.WeaponInfo objData) {
        super(DiamondHalberdConfigObj.class, weaponId, objData);
    }
