...
//            }
//            if (pPlayer.getOffhandItem().getItem() instanceof BombItem || pPlayer.getAbilities().instabuild) {
...
//            }
//        } else return InteractionResultHolder.fail(usedItemStack);
//    }
//
//    @Override
...
//        boolean hasAmmo = player.getOffhandItem().getItem() instanceof BombItem;
//        if (hasAmmo || !needsAmmo) {
//            if (hasAmmo && needsAmmo) {player.getOffhandItem().shrink(1);}
//            return true;
//        } else {
//            return false;
//        }
